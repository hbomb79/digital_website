	...
	<script>
		...
		function toggle_animations(){
			if (get_cookie("animations_disable")) {
				...
				notify("Animation setting enabled", "limegreen", "white")
			} else {
				create_cookie("animations_disable", "true", 30)
				notify("Animation setting disabled", "limegreen", "white")
			}
			settings()
		}
		function toggle_loading(){
			if (get_cookie("loading_disable")) {
				...
				notify("Loading setting enabled", "limegreen", "white")
			} else {
				create_cookie("loading_disable", "true", 30)
				notify("Loading setting disabled", "limegreen", "white")
			}
			settings()
		}
	</script>
