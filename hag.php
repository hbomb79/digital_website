...
<body>
	...
	?>
	<div id="bg-wrapper">
	 	<div class="page-bg" id="hag-page-bg"></div> <!--Faded out and replaced using ajax-->
	</div>
			...
			<div id="container">
				<main>
					...
					<div class="image-wrapper wide">
						<img src="assets/image/hag.jpg" class="center-image" alt="Picture of GTA">
					</div>
					<div class="header">
						<h1 class="large" id="title">Heroes And Generals</h1>
					</div>
